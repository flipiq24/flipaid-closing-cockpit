...
For a BUY-side (Buyer) statement, "category" must be one of:
  - "Total Purchase Cost" → subs: "Purchase Price","Due Diligence Cost","Insurance","Cash for Keys","Escrow and Title","Prorated Property Tax","Reserves"
...
For a SELL-side (Seller) statement, "category" must be one of:
  ...
  - "Gross Profits" → subs: "After Repair Value","Escrow and Title","Prorated Transfer Tax","Prorated Tax","Concessions (Buyer's Help)","Buyers Agent Commissions","Listing Agents Commissions","Per Diem Adjustment","Asset Management Services"
